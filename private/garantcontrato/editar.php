...
<head>
    ...
    <title><?php echo APP_NAME; ?> - Editar Garantia / Contrato</title>
...
<body class="pagprivada">
    ...
    <aside class="sidebar">
        ...
        <nav>
            ...
            <a href="../gestaoconteudo/gestao.html"><i class="fa-solid fa-pen-to-square"></i> Gestão de Conteúdos
                Públicos</a>
        </nav>
    </aside>
    ...
    <main class="conteudo">
        ...
        <form class="shadow p-4 rounded" style="max-width: 850px;">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" name="fim" value="">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="entidade" value="">
            </div>
