...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Determinar o nome do tipo de entrada selecionado (para validar custo)
    $nomeTipoEntrada = '';
    ...
    $erros = array_merge(
        validar_codigo_interno_unico($codigo_interno),
        ...
        validar_numero_serie_unico($_POST['numero_serie'] ?? ''),
        ...
        <div class="tab-content" id="equipTabsContent">
            ...
            <div class="tab-pane fade show active" id="dados" role="tabpanel">
                <div class="p-3 border rounded bg-light">
                    ...
                    <input type="number" name="ano_fabrico" class="form-control mb-2" min="1900" max="<?= date('Y') ?>"
                        value="<?= htmlspecialchars($_POST['ano_fabrico'] ?? '') ?>">

                    <label>Custo de Aquisição (€)</label>
                    <input type="number" name="custo_aquisicao" class="form-control mb-2" min="0" step="0.01"
