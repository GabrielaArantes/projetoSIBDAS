...
<head>
    ...
    <title><?php echo APP_NAME; ?> - Inserir Equipamentos</title>
...
<body class="pagprivada">
    ...
    <aside class="sidebar">
        <nav>
            ...
            <a href="listar.html" class="active"><i class="fa-solid fa-stethoscope"></i> Equipamentos</a>
            ...
            <div class="tab-content" id="equipTabsContent">
                ...
                <div class="tab-pane fade" id="fornecedor" role="tabpanel">
                    <div class="p-3 border rounded bg-light">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" class="form-control" name="fornecedor_telefone" pattern="[0-9]{9}"
                                maxlength="9" placeholder="Ex: 912345678" required>
                ...
                <div class="tab-pane fade" id="localizacao" role="tabpanel">
                    <div class="p-3 border rounded bg-light">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold">Observações</label>
                            <textarea class="form-control" rows="3" name="local_observacoes"></textarea>
                        </div>
                    ...
                    <div class="p-3 border rounded bg-light">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="garantia_entidade"
                                placeholder="Ex.: Philips, Manutec">
                        </div>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold">Observações da garantia/contrato</label>
                            <textarea class="form-control" rows="4" name="garantia_observacoes"
                                placeholder="Observações sobre a garantia ou contrato de manutenção"></textarea>
                        </div>
