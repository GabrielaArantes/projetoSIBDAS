...
INSERT INTO `agents` (`id`, `nome`, `email`, `password`, `perfil`, `last_login`, `created_at`, `updated_at`, `agent_ativo`, `id_perfil`) VALUES
	(1, 'Carla Mendes', _binary 0xfa51ff868bb2f34e9d75df1ad4aff0d01e93ef52007a700b83800987997f90ec, '$2y$10$XWhyWtFRCY3Sia9TK/uEjeix1iqi6zwdF9biNvjlxBdFmIqTIfVbu', 'Administrador', '2026-06-23 10:54:31', '2026-06-21 11:01:58', '2026-06-23 10:54:31', 1, 1),
	...
	(7, 'Filipe Gonçalves', _binary 0x55d71edb99a85e38b3f75491743877bcafa171b48005792b13930bd0203b337e, '$2y$10$fnrNsAaBrqSox0ZesvsQe.Ufqx07BFTyZvBL8HM/tzYr6cJU3HgCG', 'Profissional de Saude', '2026-06-23 10:54:03', '2026-06-21 11:02:00', '2026-06-23 10:54:03', 1, 3),
...
-- A despejar dados para tabela db1241094.documento: ~8 rows (aproximadamente)
...
INSERT INTO `equipamento` (`id`, `codigo_interno`, `nome`, `categoria`, `marca`, `modelo`, `num_serie`, `fabricante`, `data_aquisicao`, `ano_fabrico`, `custo`, `tipo_entrada`, `estado`, `equipamento_ativo`, `criticidade`, `observacoes`, `id_localizacao`, `id_categoria`, `id_estado`, `id_criticidade`, `id_tipo_entrada`) VALUES
	...
	(2, 'EQ002', 'Ventilador Pulmonar', 'Suporte de vida', 'Dräger', 'Evita V500', 'SN002', 'Dräger', '2021-06-15', 2020, 12000.00, 'Compra', 'Ativo', 1, 'Suporte de vida', NULL, 2, 2, 1, 4, 1),
	...
	(5, 'EQ005', 'Ecógrafo', 'Diagnóstico', 'Siemens', 'ACUSON X300', 'SN005', 'Siemens', '2020-11-12', 2019, 25000.00, 'Compra', 'Ativo', 1, 'Alta', NULL, 5, 4, 1, 3, 1),
	...
	(7, 'EQ007', 'Autoclave', 'Esterilização', 'Getinge', 'GSS67H', 'SN007', 'Getinge', '2019-07-22', 2018, 15000.00, 'Compra', 'Ativo', 1, 'Média', '', 7, 6, 1, 2, 1),
	...
	(10, 'EQ010', 'Eletrocardiógrafo', 'Diagnóstico', 'GE Healthcare', 'MAC 5500', 'SN010', 'GE Healthcare', '2020-08-25', 2019, 7000.00, 'Compra', 'Inativo', 1, 'Média', NULL, 5, 4, 6, 2, 1),
	...
	(12, 'EQ012', 'Ventilador UCI', 'Suporte de vida', 'Dräger', 'Savina 300', 'SN012', 'Dräger', '2021-12-05', 2020, 11000.00, 'Compra', 'Ativo', 1, 'Suporte de vida', NULL, 2, 2, 1, 4, 1),
	...
	(14, 'EQ014', 'Monitor de Pressão', 'Monitorização', 'Philips', 'SureSigns VS4', 'SN014', 'Philips', '2022-09-20', 2021, 3500.00, 'Compra', 'Em manutenção', 1, 'Alta', NULL, 1, 1, 2, 3, 1),
	(15, 'EQ015', 'Desfibrilhador DEA', 'Suporte de vida', 'Philips', 'HeartStart FRx', 'SN015', 'Philips', '2020-05-08', 2019, 1800.00, 'Compra', 'Ativo', 1, 'Suporte de vida', NULL, 7, 2, 1, 4, 1),
	...
	(17, 'EQ017', 'Centrifugadora', 'Laboratório', 'Eppendorf', '5810R', 'SN017', 'Eppendorf', '2021-04-22', 2020, 4000.00, 'Compra', 'Ativo', 1, 'Baixa', NULL, 7, 5, 1, 1, 1),
	(18, 'EQ018', 'Cadeira de Rodas Elétrica', 'Reabilitação', 'Permobil', 'M3 Corpus', 'SN018', 'Permobil', '2022-07-14', 2021, 8500.00, 'Compra', 'Ativo', 1, 'Baixa', NULL, 4, 7, 1, 1, 1),
	...
	(20, 'EQ020', 'Incubadora Neonatal', 'Suporte de vida', 'Dräger', 'Caleo', 'SN020', 'Dräger', '2020-09-18', 2019, 22000.00, 'Compra', 'Ativo', 1, 'Suporte de vida', NULL, 8, 2, 1, 4, 1),
	(21, 'EQ021', 'Tensiómetro Digital', 'Monitorização', 'Omron', 'M6 Comfort', 'SN021', 'Omron', '2023-01-05', 2022, 150.00, 'Compra', 'Ativo', 1, 'Baixa', NULL, 5, 1, 1, 1, 1),
...
-- A despejar dados para tabela db1241094.equipamento_fornecedor: ~24 rows (aproximadamente)
...
INSERT INTO `fornecedor` (`id`, `nome`, `nif`, `telefone`, `email`, `morada`, `website`, `pessoa_contacto`, `telefone_contacto`, `tipo`, `fornecedor_ativo`, `observacoes`, `id_tipo_fornecedor`) VALUES
	...
	(2, 'Dräger Portugal', '500123002', '210000002', 'drager@exemplo.pt', 'Rua da Saúde 2, Lisboa', 'www.drager.pt', 'João Costa', '912000002', 'Fabricante', 0, NULL, 1),
	...
	(6, 'B. Braun Portugal', '500123006', '210000006', 'bbraun@exemplo.pt', 'Rua da Saúde 6, Lisboa', 'www.bbraun.pt', 'Rui Martins', '912000006', 'Fabricante', 1, '', 1),
	(7, 'Siemens Healthineers', '500123007', '210000007', 'siemens@exemplo.pt', 'Rua da Saúde 7, Lisboa', 'www.siemens.pt', 'Sofia Pereira', '912000007', 'Fabricante', 1, NULL, 1),
